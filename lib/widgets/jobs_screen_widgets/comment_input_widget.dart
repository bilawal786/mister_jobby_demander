...
import 'package:mister_jobby/models/jobs_models/single_job_comments.dart';
import 'package:mister_jobby/providers/jobs_provider/single_job_comments_provider.dart';
import 'package:provider/provider.dart';

class CommentInputWidget extends StatefulWidget {
  final int jobId;
  const CommentInputWidget({Key? key, required this.jobId}) : super(key: key);
