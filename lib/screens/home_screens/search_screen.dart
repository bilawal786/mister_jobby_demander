...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final searchCategoriesData = Provider.of<SearchCategoriesProvider>(context, listen: true);
    final extractData = searchCategoriesData.searchCategoriesModel;
    final childCategory = searchCategoriesData.searchCategoriesModel;
    ...
    // final extractAllCate = mainCategoryData.allCategories;
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
