...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/flyers_distribution_step.dart';


class FlyersDistributionScreen extends StatefulWidget {
  const FlyersDistributionScreen({Key? key}) : super(key: key);

  @override
  State<FlyersDistributionScreen> createState() => _FlyersDistributionScreenState();
}

class _FlyersDistributionScreenState extends State<FlyersDistributionScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              constProviderData.postJob(
                ...
                constProviderData.numberOfFlyersSliderValue.toString(),
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const FlyersDistributionStep(),
        ),
        Step(
