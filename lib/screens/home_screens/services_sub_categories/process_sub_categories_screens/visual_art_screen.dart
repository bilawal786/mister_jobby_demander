...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/visual_art_step.dart';

class VisualArtScreen extends StatefulWidget {
  const VisualArtScreen({Key? key}) : super(key: key);

  @override
  State<VisualArtScreen> createState() => _VisualArtScreenState();
}

class _VisualArtScreenState extends State<VisualArtScreen> {
  int currentStep = 0;
