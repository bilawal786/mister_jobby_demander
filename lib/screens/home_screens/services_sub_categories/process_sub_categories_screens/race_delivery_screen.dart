...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/race_delivery_step.dart';


class RaceDeliveryScreen extends StatefulWidget {
  const RaceDeliveryScreen({Key? key}) : super(key: key);

  @override
  State<RaceDeliveryScreen> createState() =>
      _RaceDeliveryScreenState();
}

class _RaceDeliveryScreenState extends State<RaceDeliveryScreen> {
  int currentStep = 0;
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const RaceDeliveryStep(),
        ),
        Step(
