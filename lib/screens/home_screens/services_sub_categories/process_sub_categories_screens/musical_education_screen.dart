...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/musical_education_step.dart';

class MusicalEducationScreen extends StatefulWidget {
  const MusicalEducationScreen({Key? key}) : super(key: key);

  @override
  State<MusicalEducationScreen> createState() => _MusicalEducationScreenState();
}

class _MusicalEducationScreenState extends State<MusicalEducationScreen> {
  int currentStep = 0;
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const MusicalEducationStep(),
        ),
        Step(
