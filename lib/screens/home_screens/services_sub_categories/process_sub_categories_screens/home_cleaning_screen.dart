...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/home_cleaning_step.dart';

class HomeCleaningScreen extends StatefulWidget {
  const HomeCleaningScreen({Key? key}) : super(key: key);
...
class _HomeCleaningScreenState extends State<HomeCleaningScreen> {
        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print(
                  "own material: ${constProviderData.surfaceCleanSliderValue}");
              print(
                  "own material: ${constProviderData.checkApplianceCleaning}");
              ...
              constProviderData.postJob(
                ...
                constProviderData.checkApplianceCleaning.toString(),
                constProviderData.fixesAmount.toString(),
                constProviderData.needWork,
                constProviderData.checkWindowCleaning.toString(),
                constProviderData.checkIroning.toString(),
                constProviderData.frequencyTitle,
                constProviderData.pickupAddress,
                constProviderData.destinationAddress,
                constProviderData.surfaceCleanSliderValue.toString(),
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, need, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) && (need.frequencyTrueValue > 0))
                        ? Expanded(
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const HomeCleaningStep(),
        ),
        Step(
