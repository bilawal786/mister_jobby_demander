...
class CutTreeScreen extends StatefulWidget {
  const CutTreeScreen({Key? key}) : super(key: key);

  @override
  State<CutTreeScreen> createState() => _CutTreeScreenState();
}

class _CutTreeScreenState extends State<CutTreeScreen> {
  int currentStep = 0;
  @override
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_,size,child) => Row(
                  children: <Widget>[
                    if((size.smallSizedFurnitureAmount > 0 || size.mediumSizedFurnitureAmount > 0 || size.largeSizedFurnitureAmount > 0) &&(size.jobberBringMaterialYes == true || size.jobberBringMaterialNo == true) && (size.jobberRemoveWasteYes == true || size.jobberRemoveWasteNo == true))
                      Expanded(
