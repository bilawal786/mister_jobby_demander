...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/rid_clutter_step.dart';

class RidClutterScreen extends StatefulWidget {
  const RidClutterScreen({Key? key}) : super(key: key);

  @override
  State<RidClutterScreen> createState() => _RidClutterScreenState();
}

class _RidClutterScreenState extends State<RidClutterScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
