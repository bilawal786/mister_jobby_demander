...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/accompaniment_race_step.dart';

class AccompanimentRaceScreen extends StatefulWidget {
  const AccompanimentRaceScreen({Key? key}) : super(key: key);

  @override
  State<AccompanimentRaceScreen> createState() =>
      _AccompanimentRaceScreenState();
}

class _AccompanimentRaceScreenState extends State<AccompanimentRaceScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  int? price = 0;
        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print(
                  "selected request frequency : ${constProviderData.frequencyTitle}");
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const AccompanimentRaceStep(),
        ),
        Step(
