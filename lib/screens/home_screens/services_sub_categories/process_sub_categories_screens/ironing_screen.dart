...
class IroningScreen extends StatefulWidget {
  ...
  @override
  State<IroningScreen> createState() => _IroningScreenState();
}
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              constProviderData.postJob(
                ...
                constProviderData.numberOfClotheTitle,
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, size, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) && (size.numberOfClotheTrueValue > 0 ) &&
