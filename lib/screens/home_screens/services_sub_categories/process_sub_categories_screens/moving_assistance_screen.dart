...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/moving_assistance_step.dart';

class MovingAssistanceScreen extends StatefulWidget {
  const MovingAssistanceScreen({Key? key}) : super(key: key);

  @override
  State<MovingAssistanceScreen> createState() => _MovingAssistanceScreenState();
}

class _MovingAssistanceScreenState extends State<MovingAssistanceScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              constProviderData.postJob(
                ...
                constProviderData.areaOfMoveSliderValue.toString(),
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, size, child) => Row(
                  children: <Widget>[
                     ((currentStep < 1) && (size.jobberBringMaterialTitle == "Yes" || size.jobberBringMaterialTitle == "No"))?
                      Expanded(
  ...
  List<Step> getSteps() => [
    Step(
      ...
      title: const Text(""),
      content: const MovingAssistanceStep(),
    ),
    Step(
