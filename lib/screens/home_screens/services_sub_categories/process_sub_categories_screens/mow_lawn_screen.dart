...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/mow_lawn_step.dart';

class MowLawnScreen extends StatefulWidget {
  const MowLawnScreen({Key? key}) : super(key: key);

  @override
  State<MowLawnScreen> createState() => _MowLawnScreenState();
}

class _MowLawnScreenState extends State<MowLawnScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, lawnData, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) &&
                        (lawnData.jobberOwnMoverTitle == 'Yes' || lawnData.jobberOwnMoverTitle == 'No') &&
                        (lawnData.jobberRemoveWasteTitle == 'Yes' || lawnData.jobberRemoveWasteTitle == 'No') &&
