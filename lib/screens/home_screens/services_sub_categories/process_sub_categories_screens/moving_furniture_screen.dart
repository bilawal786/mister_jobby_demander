...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/moving_furniture_step.dart';

class MovingFurnitureScreen extends StatefulWidget {
  const MovingFurnitureScreen({Key? key}) : super(key: key);

  @override
  State<MovingFurnitureScreen> createState() => _MovingFurnitureScreenState();
}
...
class _MovingFurnitureScreenState extends State<MovingFurnitureScreen> {
        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print(
                  "own material: ${constProviderData.jobberBringMaterialTitle}");
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const MovingFurnitureStep(),
        ),
        Step(
