...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/window_cleaning_step.dart';

class WindowCleaningScreen extends StatefulWidget {
  const WindowCleaningScreen({Key? key}) : super(key: key);

  @override
  State<WindowCleaningScreen> createState() => _WindowCleaningScreenState();
}

class _WindowCleaningScreenState extends State<WindowCleaningScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print("own material: ${constProviderData.windowCleaningTitle}");
              ...
              constProviderData.postJob(
                ...
                constProviderData.windowCleaningTitle,
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, need, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) &&
                            (need.windowCleaningTrueValue > 0) &&
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const WindowCleaningStep(),
        ),
        Step(
