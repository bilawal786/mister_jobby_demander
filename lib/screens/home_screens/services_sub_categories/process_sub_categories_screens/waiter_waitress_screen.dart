...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/waiter_waitress_step.dart';

class WaiterWaitressScreen extends StatefulWidget {
  const WaiterWaitressScreen({Key? key}) : super(key: key);

  @override
  State<WaiterWaitressScreen> createState() => _WaiterWaitressScreenState();
}

class _WaiterWaitressScreenState extends State<WaiterWaitressScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const WaiterWaitressStep(),
        ),
        Step(
