...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/svt_step.dart';

class SVTScreen extends StatefulWidget {
  const SVTScreen({Key? key}) : super(key: key);

  @override
  State<SVTScreen> createState() => _SVTScreenState();
}

class _SVTScreenState extends State<SVTScreen> {
  int currentStep = 0;
