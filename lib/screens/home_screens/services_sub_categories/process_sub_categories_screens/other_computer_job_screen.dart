...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/other_computer_job_step.dart';


class ComputerJobScreen extends StatefulWidget {
  const ComputerJobScreen({Key? key}) : super(key: key);

  @override
  State<ComputerJobScreen> createState() => _ComputerJobScreenState();
}

class _ComputerJobScreenState extends State<ComputerJobScreen> {
  int currentStep = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final subCategoryTitle = routeArgs['subCategoryTitle'];    final constProviderData =
