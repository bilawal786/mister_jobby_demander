        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print("own material: ${constProviderData.baseBoardInstallValue}");
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, size, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) && (size.baseBoardInstallTitle == "Yes" || size.baseBoardInstallTitle == "No") && (size.fixesAmount > 0))?
                      Expanded(
