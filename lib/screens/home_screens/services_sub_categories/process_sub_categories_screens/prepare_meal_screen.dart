...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/prepare_meal_step.dart';

class PrepareMealScreen extends StatefulWidget {
  const PrepareMealScreen({Key? key}) : super(key: key);

  @override
  State<PrepareMealScreen> createState() => _PrepareMealScreenState();
}

class _PrepareMealScreenState extends State<PrepareMealScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
