...
class TerraceCleaningScreen extends StatefulWidget {
  ...
  @override
  State<TerraceCleaningScreen> createState() => _TerraceCleaningScreenState();
}

class _TerraceCleaningScreenState extends State<TerraceCleaningScreen> {
  int currentStep = 0;
  @override
  ...
  List<Step> getSteps() => [
    Step(
      ...
      title: const Text(""),
      content: const TerraceCleaningStep(),
    ),
    Step(
