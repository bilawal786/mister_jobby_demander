...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/pool_washing_step.dart';

class PoolWashingScreen extends StatefulWidget {
  const PoolWashingScreen({Key? key}) : super(key: key);

  @override
  State<PoolWashingScreen> createState() => _PoolWashingScreenState();
}

class _PoolWashingScreenState extends State<PoolWashingScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  int? price = 0;
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, lawnData, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) && (lawnData.frequencyTrueValue > 0))
                        ? Expanded(
