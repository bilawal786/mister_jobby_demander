...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/ses_step.dart';

class SESScreen extends StatefulWidget {
  const SESScreen({Key? key}) : super(key: key);

  @override
  State<SESScreen> createState() => _SESScreenState();
}

class _SESScreenState extends State<SESScreen> {
  int currentStep = 0;
