...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/job_removal_step.dart';

class JobRemovalScreen extends StatefulWidget {
  const JobRemovalScreen({Key? key}) : super(key: key);

  @override
  State<JobRemovalScreen> createState() => _JobRemovalScreenState();
}

class _JobRemovalScreenState extends State<JobRemovalScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
