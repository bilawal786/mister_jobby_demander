...
class HedgeTrimmingScreen extends StatefulWidget {
  const HedgeTrimmingScreen({Key? key}) : super(key: key);

  @override
  State<HedgeTrimmingScreen> createState() => _HedgeTrimmingScreenState();
}

class _HedgeTrimmingScreenState extends State<HedgeTrimmingScreen> {
  int currentStep = 0;
  @override
