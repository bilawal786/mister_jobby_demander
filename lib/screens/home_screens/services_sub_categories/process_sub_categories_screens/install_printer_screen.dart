...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/install_printer_step.dart';

class InstallPrinterScreen extends StatefulWidget {
  const InstallPrinterScreen({Key? key}) : super(key: key);

  @override
  State<InstallPrinterScreen> createState() => _InstallPrinterScreenState();
}

class _InstallPrinterScreenState extends State<InstallPrinterScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const InstallPrinterStep(),
        ),
        Step(
