...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/cleaning_job_step.dart';

class CleaningJobScreen extends StatefulWidget {
  const CleaningJobScreen({Key? key}) : super(key: key);

  @override
  State<CleaningJobScreen> createState() => _CleaningJobScreenState();
}

class _CleaningJobScreenState extends State<CleaningJobScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
