...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/weeding_step.dart';

class WeedingScreen extends StatefulWidget {
  const WeedingScreen({Key? key}) : super(key: key);

  @override
  State<WeedingScreen> createState() => _WeedingScreenState();
}

class _WeedingScreenState extends State<WeedingScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              constProviderData.postJob(
                ...
                constProviderData.areaToClearSliderValue.toString(),
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_, size, child) => Row(
                  children: <Widget>[
                     ((currentStep < 1) && (size.jobberRemoveWasteTitle == "Yes" ||
