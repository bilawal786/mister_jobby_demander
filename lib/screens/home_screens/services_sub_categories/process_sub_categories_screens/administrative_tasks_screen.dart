...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/administrative_task_step.dart';

class AdministrativeTaskScreen extends StatefulWidget {
  const AdministrativeTaskScreen({Key? key}) : super(key: key);

  @override
  State<AdministrativeTaskScreen> createState() => _AdministrativeTaskScreenState();
}

class _AdministrativeTaskScreenState extends State<AdministrativeTaskScreen> {
  int currentStep = 0;
