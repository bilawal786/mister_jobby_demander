...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/deliver_groceries_step.dart';

class DeliverGroceriesScreen extends StatefulWidget {
  const DeliverGroceriesScreen({Key? key}) : super(key: key);

  @override
  State<DeliverGroceriesScreen> createState() => _DeliverGroceriesScreenState();
}

class _DeliverGroceriesScreenState extends State<DeliverGroceriesScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: const DeliverGroceriesStep(),
        ),
        Step(
