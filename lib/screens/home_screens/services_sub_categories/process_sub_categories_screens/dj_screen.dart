...
import '../../../../screens/home_screens/services_sub_categories/process_sub_categories_steps/dj_step.dart';
                ...
                builder: (_, need, child) => Row(
                  children: <Widget>[
                    ((currentStep < 1) &&
                            ...
                            (need.jobberOwnMoverTitle == "Yes".tr() ||
                                need.jobberOwnMoverTitle == "No".tr() ))
                        ? Expanded(
