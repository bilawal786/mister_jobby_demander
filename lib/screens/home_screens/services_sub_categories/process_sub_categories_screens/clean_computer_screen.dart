...
class CleanComputerScreen extends StatefulWidget {
  ...
  @override
  State<CleanComputerScreen> createState() => _CleanComputerScreenState();
}

class _CleanComputerScreenState extends State<CleanComputerScreen> {
  int currentStep = 0;
  int? mainCateId;
  int? subCateId;
  String? subCateTitle;
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              constProviderData.postJob(
                ...
                constProviderData.checkInstallingValue.toString(),
                constProviderData.checkDataBackUpValue.toString(),
                "",
