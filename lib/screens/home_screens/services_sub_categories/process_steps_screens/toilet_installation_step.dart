...
class ToiletInstallationStep extends StatelessWidget {
  const ToiletInstallationStep({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "Toilet_Installation_Step_Title",
          ...
          Text(
            "Toilet_Installation_Step_SubTitle",
