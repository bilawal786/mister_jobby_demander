...
class BulbInstallationStep extends StatelessWidget {
  const BulbInstallationStep({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            "Bulb_Installation_Step_SubTitle",
