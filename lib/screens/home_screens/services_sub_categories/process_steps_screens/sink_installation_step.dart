...
class SinkInstallationStep extends StatelessWidget {
  const SinkInstallationStep({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            "Sink_Installation_Step_SubTitle",
