...
class FaucetInstallationStep extends StatelessWidget {
  const FaucetInstallationStep({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "Faucet_Installation_Step_Title",
          ...
          Text(
            "Faucet_Installation_Step_SubTitle",
