...
class GardeningJobStep extends StatelessWidget {
  const GardeningJobStep({Key? key}) : super(key: key);
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: 'Gardening_Job_Step_Item2_Title'.tr(),
              isDense: true,
            ),
            style: Theme.of(context).textTheme.bodySmall,
            maxLines: 5,
