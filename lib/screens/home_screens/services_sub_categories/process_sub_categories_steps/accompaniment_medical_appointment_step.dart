...
class AccompanimentMedicalAppointmentStep extends StatelessWidget {
  const AccompanimentMedicalAppointmentStep({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "Accompaniment_Medical_Appointment_Step_Title",
