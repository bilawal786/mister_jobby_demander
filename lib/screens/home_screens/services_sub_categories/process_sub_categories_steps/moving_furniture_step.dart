...
class MovingFurnitureStep extends StatefulWidget {
  const MovingFurnitureStep({Key? key}) : super(key: key);

  @override
  State<MovingFurnitureStep> createState() => _MovingFurnitureStepState();
}

class _MovingFurnitureStepState extends State<MovingFurnitureStep> {
