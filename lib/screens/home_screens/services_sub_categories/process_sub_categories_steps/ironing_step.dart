              ...
              builder: (_, requestFrequencyData, child) => SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => OutlineSelectedButton(
                    ...
                    textTitle: index == 0
                        ? "Ironing__Step_Button1_Title"
                        : index == 1
                        ? "Ironing__Step_Button2_Title"
                        : index == 2
                        ? "Ironing__Step_Button3_Title"
                        : "Ironing__Step_Button4_Title",
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => OutlineSelectedButton(
                  onTap: () => requestFrequencyData
                      .requestFrequencyFunction(index),
                  textTitle: index == 0
                      ? "Ironing__Step_Button5_Title"
                      : index == 1
                      ? "Ironing__Step_Button6_Title"
                      : index == 2
                      ? "Ironing__Step_Button7_Title"
                      : "Ironing__Step_Button8_Title",
                  color: requestFrequencyData.requestFrequencyTrueValue -
                      1 ==
                      index
                      ? Colors.blue.shade50
