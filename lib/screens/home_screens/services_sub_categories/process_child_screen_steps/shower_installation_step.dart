...
class ShowerInstallationStep extends StatelessWidget {
  const ShowerInstallationStep({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "Shower_Installation_Step_Title",
          ...
          Text(
            "Shower_Installation_Step_SubTitle",
