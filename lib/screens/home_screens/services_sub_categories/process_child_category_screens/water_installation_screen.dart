...
import '../process_child_screen_steps/water_installation_step.dart';
        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print("watter leaks fixes Amount: ${constProviderData.fixesAmount}");
            ...
            return Consumer<ConstProvider>(
              builder: (_,waterLeakValue,child)=>
               Container(
                ...
                child: Row(
                  children: <Widget>[
                    ((currentStep < 1) && (waterLeakValue.fixesAmount>0))?
                    Expanded(
                    ...
                    ((currentStep == 1) &&
                        (waterLeakValue.duration > 0) &&
                        (waterLeakValue.hourlyRate > 0))
                        ? Expanded(
                      child: ElevatedButton(
                        onPressed: details.onStepContinue,
                        style: ElevatedButton.styleFrom(
                    ...
                    (currentStep == 2 &&
                        (waterLeakValue.completeAddress != '') &&
                        (waterLeakValue.postalCode != '') &&
                        (waterLeakValue.countryDropDownValue != 'null'))
                        ? Expanded(
                      child: ElevatedButton(
                        onPressed: details.onStepContinue,
                        style: ElevatedButton.styleFrom(
