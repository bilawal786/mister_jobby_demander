...
import '../process_child_screen_steps/hang_picture_step.dart';
        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print("Hanging Picture Amount: ${constProviderData.pictureAmount}");
