        ...
        body: Stepper(
          ...
          onStepContinue: () {
            ...
            if (isLastStep) {
              ...
              print("Bulb Installation Amount: ${constProviderData.bulbInstallationAmount}");
              ...
              constProviderData.postJob(
                ...
                constProviderData.bulbInstallationAmount.toString(),
            ...
            return Container(
              ...
              child: Consumer<ConstProvider>(
                builder: (_,size,child) => Row(
                  children: <Widget>[
                    ( (currentStep < 1) && size.bulbInstallationAmount > 0 )?
                    Expanded(
