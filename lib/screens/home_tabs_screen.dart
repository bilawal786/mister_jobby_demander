            ...
            SliverAppBar(
              ...
              title: Container(
                ...
                margin: EdgeInsets.only(top: MediaQuery.of(context).size.width / 30 ),
                  child: Text("Home_AppBar_Title", style: Theme.of(context).textTheme.titleLarge,).tr()),
                ...
                tabs: [
                  Tab(
                    child: GestureDetector(
                      onTap: ()=> Navigator.of(context).pushNamed(MyRoutes.SEARCHROUTE),
                      child: Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text("Search_Hint_Text", style: Theme.of(context).textTheme.bodyMedium,).tr(),
                          ],
                        ),
                      ),
                    ),
