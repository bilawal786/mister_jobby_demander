...
class _InProgressTabState extends State<InProgressTab> {
  ...
  Widget build(BuildContext context) {
    final inProgressJobsData = Provider.of<JobsInProgressProvider>(context, listen: false);
    final extractedInProgressJobs = inProgressJobsData.inProgressJobs;
    return
      extractedInProgressJobs == null ? const Center(child: CircularProgressIndicator(),):
          extractedInProgressJobs.isEmpty ? //   SingleChildScrollView(
          Container(
