...
class SingleJobsDetails extends StatefulWidget {
  final JobsInProgressModel? jobsDetail;
  const SingleJobsDetails({Key? key, required this.jobsDetail})
      : super(key: key);

  @override
  State<SingleJobsDetails> createState() => _SingleJobsDetailsState();
}

class _SingleJobsDetailsState extends State<SingleJobsDetails> {
  @override
